...
def get_answer(question):
    nodes = get_retrieved_nodes(
        question, vector_top_k=50, reranker_top_n=20, rerank=True
    )
...
def main():
    ...
    question = "Can you provide detailed information on how to instantiate autonomous agents using the autogen python library, including an example of executing a Python script that prints 10 dad jokes?"
    answer = None
